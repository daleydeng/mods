...
namespace USACConfig
{
  ...
  //Added by Dmytro Mishkin
  enum GeometricErrorFunction {ERR_SYMMETRIC_TRANSFER_SUM, ERR_SAMPSON, ERR_SYMMETRIC_TRANSFER_MAX};
  ...
  struct Common
  {
    ...
    Common(): confThreshold		     (0.95),
      ...
      geomErrFunc (ERR_SYMMETRIC_TRANSFER_SUM),
      check_with_Symmetric (true)
